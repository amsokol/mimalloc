...
cd c_src/mimalloc
git fetch origin
git checkout v3.5.1  # Replace with desired tag
cd ../..
git add c_src/mimalloc
git commit -m "Update mimalloc to v3.5.1"
```
...
```toml
[dependencies]
mimalloc = { git = "https://github.com/amsokol/mimalloc", tag = "v3.5.1" }
```
...
```toml
[dependencies]
mimalloc = { git = "https://github.com/amsokol/mimalloc", tag = "v3.5.1", features = ["secure"] }
```
