...
cd c_src/mimalloc
git fetch origin
git checkout v3.4.3  # Replace with desired tag
cd ../..
git add c_src/mimalloc
git commit -m "Update mimalloc to v3.4.3"
```
...
```toml
[dependencies]
mimalloc = { git = "https://github.com/amsokol/mimalloc", tag = "v3.4.3", features = ["secure"] }
```
